...
__clone(int (*fn)(void *arg),
        ...
        int *ctid)
{
  JTRACE("Acquiring wrapperExecutionLock..in clone");
  WRAPPER_EXECUTION_DISABLE_CKPT();
  JTRACE("Acquired wrapperExecutionLock..in clone");
  ...
  JTRACE("Release wrapperExecutionLock..in clone");
  return tid;
}
