...
!   MPI_WEIGHTS_EMPTY
      ...
      subroutine get_fortran_constants()
        ...
        !biao.xing@samsung.com modified on 2023.5.18, in order to fix compiling issue in ompi
        !get_fortran_constants_helper --> get_fortran_arrays_helper
#ifdef MANA_USE_OPENMPI
        call get_fortran_arrays_helper(MPI_UNWEIGHTED)
        call get_fortran_arrays_helper(MPI_WEIGHTS_EMPTY)
#else
