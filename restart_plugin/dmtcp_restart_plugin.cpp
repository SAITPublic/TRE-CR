                          ...
                          const vector<string>& ckptImages)
{
  ...
  vector<char *> mtcpArgs = getKernelLoaderArgs();
  ...
  // mtcpArgs[0]=/home/srcx/mana/mana/bin/mtcp_restart
  // mtcpArgs[0]=CRAC-early-development-master/contrib/split-cuda/kernel-loader.exe
