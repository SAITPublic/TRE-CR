...
void
doGpuCompression(void * pointer, size_t size, void * dstpointer, size_t& compressedSize);

void
doGpuCompressionMS(void *srcAddrs[], size_t * srcLens, void* dstAddrs[], size_t *dstLens, /*char* hMems[],*/ size_t fragNums);
